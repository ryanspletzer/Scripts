@{
    Registrations = @(
        ...
        @{
            ...
            Hotfixes = '.\WIN81_x64_Enterprise_EN_Eval.Hotfixes.xml'
        },
        @{
...
-US_DV9.ISO"
        ...
        @{
            ...
            FileName        = "WIN10_x64_ENT_RS1_EN_Eval.iso"
        ...
        @{
            ...
            MediaType       = "ISO"
            OperatingSystem = "Windows"
            Uri             = "http://download.microsoft.com/download/2/5/4/254230E8-AEA5-43C5-94F6-88CE222A5846/14393.0.160715-1616.RS1_RELEASE_CLIENTENTERPRISEEVAL_OEMRET_X86FRE_EN-US.ISO"
